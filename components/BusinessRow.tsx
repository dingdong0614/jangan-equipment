...
export default function BusinessRow({ business }: { business: Business }) {
  ...
  return (
    <Link
      ...
      className="group grid grid-cols-[auto_1fr_auto] items-center gap-4 border-b border-line px-2 py-4 transition-colors hover:bg-surface sm:px-4"
    >
      ...
      <span className="spec-label text-xs text-amber opacity-0 transition-opacity group-hover:opacity-100">
        상세 →
      </span>
    </Link>
  );
