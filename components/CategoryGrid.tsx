      ...
      {categories.map((category) => {
        ...
        return (
          <Link
            ...
            className="group relative overflow-hidden border border-graphite bg-paper p-5 transition-colors hover:border-amber-strong"
          >
            ...
            <span className="mt-4 inline-block text-sm font-semibold text-amber-strong opacity-0 transition-opacity group-hover:opacity-100">
              목록 보기 →
            </span>
          </Link>
        );
